...
values = dict(
    ...
    description="Name of machine/techonology used for processing biosamples.",
        ...
        v3=['illumina hiseq 2000', 'illumina hiseq 2500', 'nextseq 500', 'illumina genome analyzer ii', 'illumina genome analyzer iix', 'illumina hiseq 4000', 'illumina novaseq 6000', 'illumina miseq', 'ab solid 4 system', 'illumina hiseq 1000', 'affymetrix genechip scanner 3000 7g', 'illumina hiseq 1500', 'illumina genome analyzer', 'scanning hardware', 'axon genepix 4000b scanning hardware', 'illumina hiseq 3000', 'axon- genepix4000b', '418 [affymetrix]', '454 gs flx+', 'illumina hiscansq', 'g2565ba dna microarray scanner [agilent]', 'ab solid system 3.0', 'hiseq x ten', 'genepix 4000b [axon instruments]', 'genepix 4000a [axon instruments]'],
    ...
    organism_part_5 = dict(
        ...
        v3= ['liver', 'blood', 'leaf', 'whole organism', 'bone marrow', 'lung', 'brain', 'skin', 'peripheral blood', 'spleen', 'kidney', 'breast', 'heart', 'colon', 'whole blood', 'root', 'mammary gland', 'hippocampus', 'pancreas', 'testis', 'whole embryo', 'retina', 'embryo', 'prostate', 'spinal cord'],
    ...
    experimental_designs_10 = dict(
        ...
        v3=['transcription profiling by array', 'compound treatment design', 'disease state design', 'cell type comparison design', 'genetic modification design', 'stimulus or stress design', 'genotype design', 'comparative genomic hybridization by array', 'chip-chip by tiling array', 'development or differentiation design', 'case control design', 'growth condition design', 'binding site identification design', 'strain or line design', 'time series design', 'organism part comparison design', 'other', 'transcription profiling by sage', 'transcription profiling by tiling array', 'genotyping design', 'methylation profiling by array', 'dye swap design', 'cellular modification design', 'optimization design', 'proteomic profiling by array'],
    ...
    study_type_18 = dict(
        ...
        v3= ['transcription profiling by array', 'rna-seq of coding rna', 'chip-seq', 'rna-seq of non coding rna', 'comparative genomic hybridization by array', 'methylation profiling by array', 'chip-chip by tiling array', 'other', 'methylation profiling by high throughput sequencing', 'unknown experiment type', 'chip-chip by array', 'microrna profiling by array', 'genotyping by array', 'transcription profiling by tiling array', 'dna-seq', 'transcription profiling by rt-pcr', 'rna-seq of coding rna from single cells', 'proteomic profiling by array', 'transcription profiling by sage', 'rnai profiling by array', 'genotyping by high throughput sequencing', 'clip-seq', 'translation profiling', 'medip-seq', 'microrna profiling by high-throughput sequencing'],
